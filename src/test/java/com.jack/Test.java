...
public class Test {
    public static void main(String[] args) throws IOException {
        ...
        String desk = "C:\\Users\\11095\\Desktop\\精修\\";
        File file = new File(desk);
        File[] tempList = file.listFiles();

//        String imgLocalUrl = desk+"5.jpg";
        for (File file1 : tempList) {
            if (file1.isDirectory()){
                continue;
            }
            byte[] imgBytes = getByteByPic(desk+file1.getName());
            byte[] resultImg = compressUnderSize(imgBytes,800 * 1024);
            byte2image(resultImg,desk+"\\yasuo\\"+file1.getName());
        }
